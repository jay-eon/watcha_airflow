...
with DAG(
    ...
    """.format(project_id, dataset, tb_indicator_mart, yesterday_ds)
    ...
    """.format(project_id, dataset, tb_indicator_mart, yesterday_ds, tb_event_info)
    ...
    delete_duplicates_task >> insert_data_task